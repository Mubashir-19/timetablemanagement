...
import javaswingdev.form.ClassRoom;
import javaswingdev.form.Courses;
import javaswingdev.form.Classes;
import javaswingdev.form.Form_Dashboard;
import javaswingdev.form.Section;
import javaswingdev.form.Semester;
import javaswingdev.form.Teachers_Table;
import javaswingdev.form.Timing;
        ...
        menu.addEvent(new EventMenuSelected() {
            ...
            public void menuSelected(int index, int indexSubMenu) {
                if (index == 0 && indexSubMenu == 0) {
                    ...
                    switch(indexSubMenu) {
                        //"Teachers", "Courses","Timings","Days","Class rooms","Sections","Semesters"
                        case 1:
                            showForm(new Teachers_Table());
                            break;
                        case 2:
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            showForm(new Classes());
                            break;
                        case 5:
                            showForm(new ClassRoom());
                            break;
                        case 6:
                            showForm(new Section());
                            break;
                        case 7:
                            showForm(new Semester());
                    };
                    
                    
                }
                else {
                    showForm(new Teachers_Table(index + " " + indexSubMenu));
                }
            }
        });
