...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        add(scroll);
        addTitle("MAIN");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.DASHBOARD, "Timetable Main"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.VIEW_LIST, "Manage", "Teachers", "Course Allocation","Timings","Classes","Class rooms","Sections","Semesters" ));
