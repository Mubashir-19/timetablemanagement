...
public class ClassRoom extends javax.swing.JPanel {
    ...
    public ClassRoom(String string) {
    ...
    private void initComponents() {
        ...
        add_teachername.setEnabled(false);
        ...
        add_subject.setEnabled(false);

        add_education.setText("education");
        add_education.setEnabled(false);

        add_rank.setText("rank");
        add_rank.setEnabled(false);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(add_teachername, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
                    .addComponent(add_subject, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(add_education, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(add_rank)
                    .addComponent(addSubmitButton, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        add_education.setEnabled(true);
        add_rank.setEnabled(true);
        add_subject.setEnabled(true);
        add_teachername.setEnabled(true);
        addSubmitButton.setEnabled(true);
        
        
        add_education.setText("");
        add_rank.setText("");
        add_subject.setText("");
        add_teachername.setText("");
